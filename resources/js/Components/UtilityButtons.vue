<template>
  ...
  <div class="position-fixed bottom-0 end-0 m-3 z-index-5">
    ...
    <button class="btn btn-theme btn-square shadow mt-2 d-none rounded-circle" id="backtotop" @click="scrollToTop">
      <i class="bi bi-arrow-up"></i>
    </button>
  </div>

  <!-- Add Reminder Modal -->
  <div class="modal adminuiux-modal fade" id="addreminder" tabindex="-1" aria-labelledby="addremindermodalLabel"
    aria-hidden="true">
...
onMounted(() => {
  ...
  window.addEventListener('scroll', () => {
    backBtn.classList.toggle('d-none', window.scrollY < 200)
  })
})
</script>
